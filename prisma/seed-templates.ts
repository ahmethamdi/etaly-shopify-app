...
const builtInTemplates = [
  ...
  },
  {
    ...
    description: "Emphasize free delivery",
    icon: "🎁",
  ...
  },
  {
    ...
    name: "In Stock & Ready",
    description: "Show product availability",
    icon: "✅",
    message: "✓ In stock! Ships today, arrives {eta_min_date}-{eta_max_date}",
    toneDefault: "success",
    isPro: true,
    isBuiltIn: true,
    supportsCountdown: false,
  ...
  },
  {
    ...
    description: "Sustainable delivery",
    icon: "🌱",
    message: "🌱 Carbon-neutral delivery: {eta_min_date} - {eta_max_date}",
    toneDefault: "success",
    isPro: true,
    isBuiltIn: true,
    supportsCountdown: false,
  ...
  },
  {
    ...
    description: "Ultra-fast same-day",
    icon: "⚡",
  ...
  },
  {
    ...
    icon: "💯",
    message: "Guaranteed delivery by {eta_max_date} or your money back",
    toneDefault: "info",
    isPro: false,
    isBuiltIn: true,
    supportsCountdown: false,
